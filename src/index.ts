...
export { IPlayerStatisticEventsPoster } from "interfaces/IPlayerStatisticEventsPoster";
export { IPlayerStatisticsLoader } from "interfaces/IPlayerStatisticsLoader";
export { IPlayerStatisticsPersistenceLayer } from "interfaces/IPlayerStatisticsPersistenceLayer";
export { IPlayerStatisticsProvider } from "interfaces/IPlayerStatisticsProvider";
export { IPlayerStatisticsReader } from "interfaces/IPlayerStatisticsReader";
